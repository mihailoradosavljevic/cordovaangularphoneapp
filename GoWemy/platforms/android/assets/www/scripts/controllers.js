...
gowemyAppControllers.controller('splashCtrl', ['$scope', '$http', '$rootScope', '$routeParams', '$window', '$timeout',
  function ($scope, $http, $rootScope, $routeParams, $window, $timeout) {
      ...
      var sizeProcentiVeliki = Math.round($rootScope.winwidth / 7);
      ...
      $scope.PROVERIOCENU = function () {
          ...
          $http({
              ...
              if (procentiOCENE>0) {
                  ...
                  $scope.PercentMessage = 'Congrats, your #' + $rootScope.HASHTAG + ' looks good on you!';
                  ...
                  $scope.PercentMessage = 'Sorry, your #' + $rootScope.HASHTAG + ' does not look so good on you.';
...
gowemyAppControllers.controller('getOpinionCtrl', ['$scope', '$http', '$rootScope', '$routeParams', '$location', 'localStorageService', '$window', '$timeout',
  function ($scope, $http, $rootScope, $routeParams, $location, localStorageService, $window, $timeout) {
      $http.get('datoteka/splashscr.json').success(function (data) {
          ...
          $rootScope.BlurMeniSlikaY = Math.round($rootScope.winheight / 5.5); 
          $rootScope.UserMeniSlikaX = Math.round($rootScope.winwidth / 5.15);
          $rootScope.UserMeniSlikaY = $rootScope.UserMeniSlikaX; 
          $rootScope.ProfileMeniSlikaX = $rootScope.winwidth;
          $rootScope.ProfileMeniSlikaY = Math.round($rootScope.winheight / 3);
...
gowemyAppControllers.controller('loginController', ['$scope', '$http', '$rootScope', '$routeParams', '$location', 'localStorageService', '$window',
  function ($scope, $http, $rootScope, $routeParams, $location, localStorageService, $window) {
      $http.get('datoteka/splashscr.json').success(function (data) {
          ...
          var FontSignupLoginTextBoxes3 = Math.round($rootScope.winwidth / 25);
          $rootScope.FontSignupLoginTextBoxes3 = FontSignupLoginTextBoxes3.toString() + 'px';
